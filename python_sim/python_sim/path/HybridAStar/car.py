...
WB = 1.240 * 10  # rear to front wheel
W = 1.160 * 10  # width of car
LF = (1240 + 980 / 2) / 1000 * 10  # distance from rear to vehicle front end
LB = (980 / 2) / 1000 * 10  # distance from rear to vehicle back end
MAX_STEER = 0.454  # 0.454  # [rad] maximum steering angle

BUFFER = 0.4
BUBBLE_DIST = (LF - LB) / 2.0  # distance from rear to center of vehicle.
BUBBLE_R = np.hypot((LF + LB) / 2.0, W / 2.0) * BUFFER  # bubble radius
